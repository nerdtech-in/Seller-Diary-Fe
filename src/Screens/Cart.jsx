...
export default function Cart() {
    ...
    return (
        <section class="h-screen bg-gray-100 py-3">
            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <IoMdArrowBack
                        ...
                        size={25}
                    />
                    <h1 class="text-2xl font-semibold text-icon">Your Cart</h1>
                    <div
                    ...
                    <div class="rounded-3xl bg-white shadow-lg">
                        <div class="px-4 py-6 sm:px-8 sm:py-10">
                                        ...
                                        <div class="relative flex flex-1 flex-col justify-between">
                                            <div class="sm:col-gap-5 sm:grid sm:grid-cols-2">
                                                <div class="pr-8 sm:pr-5">
                                                    ...
                                                    <p class="mx-0 mt-1 mb-0 text-sm text-icon">36EU - 4US</p>
                                                </div>
                            ...
                            <div class="mt-6 text-center">
                                <button type="button" class="group inline-flex w-full items-center justify-center rounded-md bg-primary px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
                                    Place Order
