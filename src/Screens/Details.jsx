...
export default function Details() {
    ...
    return (
        ...
        >
            <h1
                className=' font-Raleway mt-10 w-[88%] dark:text-white text-center text-2xl  tracking-wider'>
                Enter Your Details
            </h1>
            <p
                className=' font-Raleway m-0 p-0 w-[88%] dark:text-white text-center text-sm  tracking-wider'>
                To start ordering
            </p>
            <div
                ...
                <div
                    ...
                    />
                    <p
                        className=' font-Raleway dark:text-white text-left text-xs  tracking-wider'>
